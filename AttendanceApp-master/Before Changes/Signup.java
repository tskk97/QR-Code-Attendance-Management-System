...
public class Signup extends Activity implements OnClickListener {
	...
	EditText etName, etAge, etDob, etSem, etSection, etRoll, etMob, etEmail,
			etGuard;
	String Name, Age, Dob, Section, Roll, Mob, Email, Guard;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		etDob = (EditText) findViewById(R.id.regno);
		...
		etAge.setHintTextColor(Color.LTGRAY);
		etDob.setHintTextColor(Color.LTGRAY);
		...
		etAge.setTypeface(segoe);

		etDob.setTypeface(segoe);
		...
		btnFill.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				etName.setText("Arun Agarwal");
				etAge.setText("22");
				etDob.setText("01/01/1997");
				etSem.setText("6");
				etSection.setText("B");
				etRoll.setText("iit2015007");
	...
	public void onClick(View v) {
		...
		if(Err) {
			try {
				...
				lastID = dbIO.createStudent(Name, Age, Dob, Sem, Section,
	...
	public boolean validateFields()
	{
		...
		if (Name.equals("") || Age.equals("") || Dob.equals("")
			...
			n = (Age != "") && Age.matches("[0-9_]+");

			if (n) {
				Toast.makeText(this, "Invalid Age", Toast.LENGTH_SHORT)
						.show();
				Err = false;
			}
